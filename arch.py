...
class A1(nn.Module):
    def __init__(self, n_class=6, n_fmap_ch=[8, 16, 32, 64, 128], in_channel_dim=[2,3]):
        ...
        self.conv2_0_bgr_r = mVGGBlock(n_fmap_ch[1], n_fmap_ch[2], n_fmap_ch[2])
        #BOTTLENECK
        self.conv3_0_dvs = VGGBlock(4*n_fmap_ch[2], n_fmap_ch[3], n_fmap_ch[3])
        self.conv3_0_bgr = VGGBlock(4*n_fmap_ch[2], n_fmap_ch[3], n_fmap_ch[3])
        self.conv_neck = VGGBlock(2*n_fmap_ch[3], n_fmap_ch[4], n_fmap_ch[4])
        self.conv3_0_dep = VGGBlock(2*n_fmap_ch[3]+n_fmap_ch[4], n_fmap_ch[3], n_fmap_ch[3])
        self.conv3_0_seg = VGGBlock(2*n_fmap_ch[3]+n_fmap_ch[4], n_fmap_ch[3], n_fmap_ch[3])
        #DE
        self.conv2_1_dep_f = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv2_1_dep_l = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv2_1_dep_ri = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv2_1_dep_r = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv1_2_dep_f = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv1_2_dep_l = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv1_2_dep_ri = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv1_2_dep_r = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv0_3_dep_f = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        self.conv0_3_dep_l = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        self.conv0_3_dep_ri = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        self.conv0_3_dep_r = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        #SS
        self.conv2_1_seg_f = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv2_1_seg_l = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv2_1_seg_ri = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv2_1_seg_r = mVGGBlock(2*n_fmap_ch[2]+n_fmap_ch[3], n_fmap_ch[2], n_fmap_ch[2])
        self.conv1_2_seg_f = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv1_2_seg_l = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv1_2_seg_ri = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv1_2_seg_r = mVGGBlock(2*n_fmap_ch[1]+n_fmap_ch[2], n_fmap_ch[1], n_fmap_ch[1])
        self.conv0_3_seg_f = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        self.conv0_3_seg_l = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        self.conv0_3_seg_ri = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        self.conv0_3_seg_r = mVGGBlock(2*n_fmap_ch[0]+n_fmap_ch[1], n_fmap_ch[0], n_fmap_ch[0])
        #final 1x1 conv
        self.final_dep_f = nn.Conv2d(n_fmap_ch[0], 1, kernel_size=1)
        self.final_dep_l = nn.Conv2d(n_fmap_ch[0], 1, kernel_size=1)
        self.final_dep_ri = nn.Conv2d(n_fmap_ch[0], 1, kernel_size=1)
